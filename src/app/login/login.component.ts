...
export class LoginComponent {
  ...
  constructor(private http: HttpClient, private router: Router, private toastr: ToastrService, private service: MasterService) {
  ...
  onSignup() {
    this.service.registerUser(this.signupobj)
      .subscribe((res: any) => {
